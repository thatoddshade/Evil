...
# money
coin = Item("Coin", "64", """This small piece of a copper and gold alloy is the
...
raw_copper = Item("Raw Copper", 64, """Copper is far more useful than you think.
""")
raw_dark_steel = Item("Raw Dark Steel", 64, """It is not a regular pebble
at all.""")

# ingots
iron_ingot = Item("Iron Ingot", 64, """Iron is used in the manufacture of many
objects, it is most often drawn from the subsoil in the form of ore.""")
gold_ingot = Item("Gold Ingot", 64, """Gold is a precious metal.
It is rare and naturally has a golden yellow color.""")
copper_ingot = Item("Copper Ingot", 64, """Golden red metal,
very good conductor of electricity.""")
dark_steel_ingot = Item("Dark Steel Ingot", 64, """This weird gloomy ingot
is really hard...""")
...
poisonous_potato = Item("Poisonous Potato", 64, """Eating poisonous things
is not quite good for health""")

# berries
blueberry = Item("Blue Berry", 64, """Blue and juicy.""")
purpleberry = Item("Purple Berry", 64, """Açai Berries ? Black Currants ? Blackberries ? Elderberries ?
...
# chicken
chicken = Item("Raw Chicken", 64, """Do not eat this raw meat, it could be
poisonous.""")
cooked_chicken = Item("Raw Chicken", 64, """Cooked chicken is more nutritious
